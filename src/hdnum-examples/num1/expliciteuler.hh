...
*/
template <class M> class ExplicitEuler {
public:
  ...
  void set_dt(time_type dt_) { dt = dt_; }
  ...
  //! get current state
  const hdnum::Vector<number_type> &get_state() const { return u; }

  //! get current time
  time_type get_time() const { return t; }
