...
Vec nonlinear_fit(const Vec &N, const Vec &t, const Vec &p0)
{
  ...
  Vec p(p0);            // Objekt f�r die Loesung
  newton.solve(nlp, p); // Berechne L�sung
  return p;
}
...
int main()
{
  ...
  Vec N = {16,     18,     21,     26,     53,     66,     117,    150,
           188,    240,    400,    639,    795,    902,    1139,   1296,
  ...
  std::vector<std::string> tstring = {
      ...
      "16/04/2020", "17/04/2020", "18/04/2020"}; // Datum zur Ausgabe
  gnuplot("N.dat", tstring, N);                  // Ausgabe der Daten

  // Italien https://de.wikipedia.org/wiki/COVID-19-Pandemie_in_Italien
  // Vec N = {39, 79, 159, 229, 326, 400, 650, 888, 1128, 1694, 2036, 2502,
